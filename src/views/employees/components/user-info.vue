  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="onSaveDetailInfo"
            >保存更新</el-button
          >
    ...
    <el-form label-width="220px">
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="updatePerBaseInfo"
              >保存更新</el-button
            >
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    async getPersonalDetail() {
      ...
      this.$refs.userDetailPhoto.fileList.push({
        url: this.formData.staffPhoto,
      })
    },
    //更新个人详情信息
    async onSaveDetailInfo() {
      if (this.$refs.employeesPhoto.loading) {
        return this.$message.warning('图片正在上传中，请不要重复操作')
      }
    ...
    //更新用户详情基础信息
    async updatePerBaseInfo() {
      if (this.$refs.userDetailPhoto.loading) {
        return this.$message.warning('图片正在上传中，请不要重复操作')
      }
